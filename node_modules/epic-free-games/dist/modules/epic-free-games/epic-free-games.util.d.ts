import { EpicFreeGamesOptions, HasPromotionalOffers, HasUpcomingPromotionalOffers, InNextWeek, InThisWeek, IsBaseGame, IsFree, WillBeFree } from './types';
import { Country, Locale } from '../../core';
export declare class EpicFreeGamesUtil {
...
//# sourceMappingURL=epic-free-games.util.d.ts.map